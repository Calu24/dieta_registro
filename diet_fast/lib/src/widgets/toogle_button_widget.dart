    ...
    return ChangeNotifierProvider(
      ...
      child: Builder(
        builder: (BuildContext context) {
          Provider.of<_ToggleButtonsModel>(context).activeTextColor =
              this.activeTextColor;
          Provider.of<_ToggleButtonsModel>(context).activeColor =
              this.activeColor;
          Provider.of<_ToggleButtonsModel>(context).inactiveTextColor =
              this.inactiveTextColor;
          Provider.of<_ToggleButtonsModel>(context).height = this.height;

          int itemSeleccionado =
              Provider.of<_ToggleButtonsModel>(context).itemSeleccionado;
          return Column(
            children: <Widget>[
              Container(
...
class _ToogleButton extends StatelessWidget {
  const _ToogleButton(
      {@required this.index, @required this.text, this.onPressed});
  ...
  Widget build(BuildContext context) {
    ...
    return TextButton(
        onPressed: () {
          Provider.of<_ToggleButtonsModel>(context, listen: false)
              .itemSeleccionado = this.index;
          if (onPressed != null) {
        ...
        child: Text(
          ...
          style: TextStyle(
              ...
              fontWeight: FontWeight.bold,
              color: toggleModel.itemSeleccionado == index
                  ? toggleModel.activeTextColor
                  : toggleModel.inactiveTextColor),
        ),
        style: TextButton.styleFrom(
          backgroundColor: toggleModel.itemSeleccionado == index
              ? toggleModel.activeColor
              : Colors.transparent,
          shape:
